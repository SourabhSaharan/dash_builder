  ...
  return (
    ...
    >
      ...
      >
        {/* Bar Chart */}
        <div>
          <h4 style={{ margin: 0 }}>Skills (time)</h4>
          <div style={{ height: 150, marginTop: 8 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={skillsData}>
                ...
                <YAxis stroke="#fff" />
                <Tooltip />
                <Bar dataKey="Time" fill="#00C49F" radius={[8,8,0,0]} onClick={(data) => window.open("https://github.com/gnitin07/resume-dashboard", "_blank")}/>
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      window.open("https://www.codechef.com/users/nitingoyal01", "_blank")
        ...
        <div>
          ...
          <div style={{ height: 160, marginTop: 10 }}>
            <ResponsiveContainer width="100%" height="100%">
              <PieChart onClick={() =>
      window.open("https://i.ibb.co/Tqv24zL9/Screenshot-2025-11-13-153247.png", "_blank")
    }>
